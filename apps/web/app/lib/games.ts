...
export const GAMES: Game[] = [
  ...
  // ════════════════════════════════════════════════════════════════════
  {
    ...
    available: true,
    apkUrl: 'https://github.com/salistar/sally-belote/releases/download/v1.0.1-signed/sally-belote-v1.0.1-prod.apk',
    apkDebugUrl: 'https://github.com/salistar/sally-belote/releases/download/latest/app-debug.apk',
    aabUrl: 'https://github.com/salistar/sally-belote/releases/download/v1.0.1-signed/sally-belote-v1.0.1-prod.aab',
    releasePage: 'https://github.com/salistar/sally-belote/releases/tag/v1.0.1-signed',
