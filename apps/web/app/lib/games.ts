...
export const GAMES: Game[] = [
  ...
  // ════════════════════════════════════════════════════════════════════
  {
    ...
    available: true,
    apkUrl: 'https://github.com/salistar/sally-belote/releases/download/latest/app-debug.apk',
    releasePage: 'https://github.com/salistar/sally-belote/releases/tag/latest',
